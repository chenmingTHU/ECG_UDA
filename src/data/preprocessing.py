...
if __name__ == '__main__':
    ...
    # pro_incartdb = DataPreprocessing('/home/workspace/mingchen/ECG_DATA/incartdb/',
    #                                  DENOISE_DATA_DIRS['incartdb'], 'incartdb')
    # pro_svdb = DataPreprocessing('/home/workspace/mingchen/ECG_DATA/svdb/',
    #                              DENOISE_DATA_DIRS['svdb'], 'svdb')

    pro_ltdb = DataPreprocessing('/home/workspace/mingchen/ECG_DATA/ltdb/',
                                 DENOISE_DATA_DIRS['ltdb'], 'ltdb')
    pro_ltdb.run()
