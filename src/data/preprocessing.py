...
def save_indices_of_datasets(dataset_name):
    ...
    root_path = osp.join(osp.join('../../data_index', dataset_name), 'entire')
    if not osp.exists(root_path):
        os.makedirs(root_path)

    load_path = osp.join('../../data', dataset_name)
...
def split_dataset(dataset_name='mitdb'):
    ...
    root_path = osp.join('../../data_index', dataset_name)
    if not osp.exists(root_path):
        os.makedirs(root_path)
...
if __name__ == '__main__':
    ...
    # pro = DataPreprocessing('/home/workspace/mingchen/ECG_DATA/mitdb/',
    #                         '../../data/mitdb/', 360)

    # pro = DataPreprocessing('/home/workspace/mingchen/ECG_DATA/incartdb/',
    #                         '../../data/incartdb/', 257)

    # pro = DataPreprocessing('/home/workspace/mingchen/ECG_DATA/svdb/',
    #                         '../../data/svdb/', 128)
    #
    # pro.run()
    ...
    save_indices_of_datasets('svdb')
    save_indices_of_datasets('incartdb')
