...
class ResidualBlock(nn.Module):
    ...
    def __init__(self, in_channel, ksize=3, dilation=1, stride=1, groups=1, double_out_channel=True):
        ...
        self.conv = nn.Conv1d(in_channel, out_channel, 1, stride, 0, dilation, groups)
...
class ResNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.layer_1 = nn.Sequential(
            ResidualBlock(8),
            ResidualBlock(16, double_out_channel=False),
            ResidualBlock(16, double_out_channel=False),
        ...
        self.layer_2 = nn.Sequential(
            ResidualBlock(16),
            ResidualBlock(32, double_out_channel=False),
            ResidualBlock(32, double_out_channel=False),
            nn.AvgPool1d(kernel_size=2)
        )
        ...
        self.layer_3 = nn.Sequential(
            ResidualBlock(32),
            ResidualBlock(64, double_out_channel=False),
            ResidualBlock(64, double_out_channel=False),
            nn.AvgPool1d(kernel_size=2)
        )
        ...
        self.layer_4 = nn.Sequential(
            ResidualBlock(64),
            ResidualBlock(128, double_out_channel=False),
            ResidualBlock(128, double_out_channel=False),
            nn.AvgPool1d(kernel_size=2)
        )
